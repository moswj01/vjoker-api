...
export interface ApiHistoryHistory extends Schema.CollectionType {
  ...
  attributes: {
    ...
    type: Attribute.Enumeration<['W', 'T']>;
...
export interface ApiWithdrawWithdraw extends Schema.CollectionType {
  ...
  attributes: {
    ...
    serial: Attribute.UID<'api::withdraw.withdraw', 'username'> &
      Attribute.SetMinMaxLength<{
        maxLength: 6;
      }>;
    rejected: Attribute.Boolean & Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
